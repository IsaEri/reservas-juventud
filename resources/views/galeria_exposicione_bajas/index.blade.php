...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                 <div class="card-header"><b>Galería de exposiciones</b>
                 @if( Auth::user()->is_admin == 1) 
                 <a href='{{route('galeria_exposicione_bajas.create')}}' class="btn btn-success btn-sm">Crear reserva</a>
                 <br><br>
                 <!-- Buscador -->
                 {!! Form::open([ 'route' => 'galeria_exposicione_bajas.index', 'method' => 'GET', 'class' => 'navbar-form pull-right']) !!}
                ...
                <div class="card-body">
                    ...
                    @foreach($galeria_exposicione_bajas as $socio)
                        <tr>
                            ...
                            @if( Auth::user()->is_admin == 1) 
                            <td><a href='{{route('galeria_exposicione_bajas.edit',['id'=>$socio->id])}}' class="btn btn-success btn-sm">Editar</a></td>
                            <td>
                                <form method="post" action="{{route('galeria_exposicione_bajas.destroy',['id'=>$socio->id])}}">
                                    @csrf
                                    {!! method_field('delete') !!}
...
@endif
                     ...
                     {{ $galeria_exposicione_bajas -> links() }}
                </div>
            </div>
        </div>
    </div>
